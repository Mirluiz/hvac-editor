...
var Canvas = /** @class */ (function () {
  ...
  Canvas.prototype.getLocalCoordinates = function (x, y) {
    ...
    var scale = function (vec) {
      return new vect_1.Vector(
        vec.x * _this.scale.amount,
        vec.y * _this.scale.amount
      );
    };
  ...
  Canvas.prototype.updateMode = function (mode) {
    ...
    this.actionObject = null;
    if (mode === "valve") {
      this.placingObject = new valve_model_1.default(
        this,
        new vect_1.Vector(this.mouse.x, this.mouse.y)
      );
    }
    if (mode === "radiator") {
      this.placingObject = new radiator_model_1.default(
        this,
        new vect_1.Vector(this.mouse.x, this.mouse.y)
      );
    }
