...
var pipe_model_1 = __importDefault(require("../app/2d/models/heating/pipe.model"));
...
},{"../app/2d/models/heating/pipe.model":13,"../app/geometry/vect":21}],2:[function(require,module,exports){
"use strict";
...
},{"../models/canvas.model":6,"../views/canvas.view":18,"../views/stats.view":19,"./object.controller":3,"./pipe.controller":4}],3:[function(require,module,exports){
"use strict";
...
},{"../../geometry/vect":21,"../models/ghost/heating/radiator.model":10,"../models/ghost/heating/valve.model":11,"../models/heating/radiator.model":14,"../models/heating/valve.model":15}],4:[function(require,module,exports){
"use strict";
...
},{"../../geometry/vect":21,"../models/ghost/heating/pipe.model":9,"../models/heating/fitting.model":12,"../models/heating/pipe.model":13}],5:[function(require,module,exports){
"use strict";
...
},{"../../ui/controller/info-panel.controller":26,"../../ui/controller/toolbar.controller":27,"./controllers/canvas.controller":2}],6:[function(require,module,exports){
"use strict";
...
},{"../../../_test_/common":1,"../../geometry/vect":21,"../overlap.model":17,"./ghost/heating/radiator.model":10,"./ghost/heating/valve.model":11}],7:[function(require,module,exports){
"use strict";
...
},{"../../../../geometry/vect":21,"../../main.model":16}],11:[function(require,module,exports){
"use strict";
...
},{"../../../geometry/vect":21,"../geometry/line.model":8,"./fitting.model":12}],14:[function(require,module,exports){
"use strict";
...
},{"../../../geometry/vect":21,"../main.model":16}],15:[function(require,module,exports){
"use strict";
...
},{"../../../geometry/vect":21,"../geometry/arc.model":7,"./pipe.model":13}],16:[function(require,module,exports){
"use strict";
...
},{"../geometry/vect":21}],18:[function(require,module,exports){
"use strict";
...
var Canvas = /** @class */function () {
    ...
    Canvas.prototype.init = function () {
        ...
        var buffer = this.initBuffers(gl, __spreadArray(__spreadArray([], this.model.pipes, true), this.model.fittings, true));
        var programInfo = {
            objectID: "asd",
    ...
    Canvas.prototype.update = function () {
        ...
        this.model.pipes.map(function (pipe) {
            ...
            if (newPipe) {
                ...
                if (!shaderProgram) return;
                var buffer = initBuffers.bind(_this)(gl, []);
                var programInfo = {
                    objectID: pipe.id,
                    program: shaderProgram,
                    attribLocations: {
    ...
    Canvas.prototype.initBuffers = function (gl, objects) {
        var _this = this;
        ...
        objects.map(function (object) {
            if (object instanceof pipe_model_1.default) {
                positions = positions.concat(_this.createRect(object));
                // colors = [
                //   0.0,
                //   0.0,
                //   0.0,
...
},{"../../geometry/vect":21,"../../math/m3":23,"../../shaders/shader":24,"../models/heating/pipe.model":13}],19:[function(require,module,exports){
"use strict";
...
},{"./2d":5}],21:[function(require,module,exports){
"use strict";
...
},{"../view/info-panel.view":28}],27:[function(require,module,exports){
"use strict";
...
},{"../view/toolbar.view":29}],28:[function(require,module,exports){
"use strict";
